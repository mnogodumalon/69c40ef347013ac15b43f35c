...
import type { Veranstaltungen, TeilnehmerAnmeldung, Teilnehmer, Veranstaltungsort, Referenten, Anmeldungen, CreateVeranstaltungen, CreateTeilnehmerAnmeldung, CreateTeilnehmer, CreateVeranstaltungsort, CreateReferenten, CreateAnmeldungen } from '@/types/app';
