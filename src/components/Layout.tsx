...
import { IconArrowBackUp, IconCalendar, IconClipboardList, IconFileText, IconLayoutDashboard, IconMapPin, IconMenu2, IconSettings, IconUsers } from '@tabler/icons-react';
import { useState, useEffect } from 'react';
import ChatWidget from '@/components/ChatWidget';
import { TopBar } from '@/components/TopBar';
import ActionsBar from '@/components/ActionsBar';

const APP_TITLE = 'EventFlow';
...
const navigation = [
  ...
  { name: 'Veranstaltungsort', href: '/veranstaltungsort', icon: IconMapPin },
  { name: 'Referenten', href: '/referenten', icon: IconFileText },
  { name: 'Veranstaltungen', href: '/veranstaltungen', icon: IconCalendar },
  { name: 'Teilnehmer', href: '/teilnehmer', icon: IconUsers },
  { name: 'Anmeldungen', href: '/anmeldungen', icon: IconClipboardList },
  { name: 'Teilnehmer-Anmeldung', href: '/teilnehmer-anmeldung', icon: IconUsers },
];

const externalNavigation = [
  { name: 'Veranstaltungsort', href: '/gateway/apps/69c40ebc8c550314b139b89d?template=list_page', icon: IconMapPin },
  { name: 'Referenten', href: '/gateway/apps/69c40eca8952a961b0ebc8c2?template=list_page', icon: IconFileText },
  { name: 'Veranstaltungen', href: '/gateway/apps/69c40eca182caae214eb183f?template=list_page', icon: IconCalendar },
  { name: 'Teilnehmer', href: '/gateway/apps/69c40ecbe70eb034258a3776?template=list_page', icon: IconUsers },
  { name: 'Anmeldungen', href: '/gateway/apps/69c40ecbd9510645d8034890?template=list_page', icon: IconClipboardList },
  { name: 'Teilnehmer-Anmeldung', href: '/gateway/apps/69c40ecc3a4966b30529982f?template=list_page', icon: IconUsers },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69c40ebc8c550314b139b89d?template=list_page"
